package com.vjj.providers
{
	...
	import com.vjj.structs.ReadyState;
	import com.vjj.structs.NetworkState;
	...
	public class HLSProvider
	{
		...
		private function _mediaTimeHandler(event:HLSEvent):void
		{
			...
			if (!_isPaused) {
				_model.broadcastEventExternally(ExternalEventName.ON_TIMEUPDATE);
			}
		...
		private function _onFrame(event:Event):void
		{
			...
			if (newWidth != 0 && newHeight != 0 && newWidth != _mediaWidth && newHeight != _mediaHeight)
			{
